...
export default function ImportCollaboratorWidget() {
  ...
  async function handleImport() {
    ...
    setTimeout(() => {
      const imported = [
        { name: 'Colaborador 1', status: 'ativo', date: '2026-02-15' },
        { name: 'Colaborador 2', status: 'inativo', date: '2026-02-15' },
      ];
      setStatus(imported);
      setLoading(false);
      getInsights('Valide e otimize o cadastro dos colaboradores: ' + JSON.stringify(imported));
    }, 1500);
  }

  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl p-4 shadow">
      <h3 className="font-semibold mb-2">Importar Colaboradores</h3>
